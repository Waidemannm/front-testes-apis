...
export default function VendaSave() {
      ...
      <div className="max-w-xl mx-auto">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-1">
            ...
            <code className="text-sm text-[#ffcb05] font-mono">/venda</code>
          </div>
          <h1 className="text-2xl font-extrabold tracking-tight">Cadastrar Venda</h1>
          <p className="text-[#6b7090] text-sm mt-1">Adiciona uma nova Venda ao banco de dados.</p>
        </div>
        ...
        {response && (
          <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
            <div className="text-green-400 font-bold text-sm mb-2">✅ Venda cadastrada com sucesso!</div>
