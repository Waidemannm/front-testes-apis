...
export default function RemedioSave() {
    ...
    <div className="min-h-screen bg-[#0d0d1a] text-[#e8e8f0] p-6">
      <div className="max-w-xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-extrabold tracking-tight">Cadastrar Remédio</h1>
          <p className="text-[#6b7090] text-sm mt-1">Adiciona um novo Remédio ao banco de dados.</p>
        </div>
        ...
        {response && (
          <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
            <div className="text-green-400 font-bold text-sm mb-2">✅ Remédio cadastrado com sucesso!</div>
