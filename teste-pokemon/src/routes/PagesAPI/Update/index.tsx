...
export default function Update() {
  ...
  const fields = [
    { name: "nome",          label: "Nome",           placeholder: "Raichu",  type: "text" },
    { name: "categoria",     label: "Categoria",       placeholder: "Mouse",   type: "text" },
    { name: "altura",        label: "Altura (m)",      placeholder: "0.8",     type: "number" },
    { name: "peso",          label: "Peso (kg)",       placeholder: "30.0",    type: "number" },
    ...
    <div className="min-h-screen bg-[#0d0d1a] text-[#e8e8f0] p-6">
      <div className="max-w-xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-extrabold tracking-tight">Atualizar Pokémon</h1>
          <p className="text-[#6b7090] text-sm mt-1">Atualiza os dados de um pokémon existente.</p>
        </div>
        ...
        {response && (
          <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
            <div className="text-green-400 font-bold text-sm mb-2">✅ Pokémon atualizado com sucesso!</div>
